<?php
/**
 * EEHarbor PHAR Loader for Detour Pro
...
spl_autoload_register(
    function ($class_name) {
        ...
        $phar_path = PATH_THIRD . 'detour_pro/detour_pro.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/detour_pro';

        $namespace = 'EEHarbor\DetourPro';
