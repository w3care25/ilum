...
use EEHarbor\User\Library\AddonBuilderClass;

class Data extends AddonBuilderClass
{
    /**
     * Framework object
     * @var object
    ...
    public function get_channel_id_pref($id)
    {
        //cache?
    ...
    public function mfields()
    {
        ...
        foreach ($fields as $row) {
            ...
            if (!empty($row->m_field_settings['value_label_pairs'])) {
                $list_items = '';
                foreach ($row->m_field_settings['value_label_pairs'] as $value => $label) {
                    $list_pairs[] = $value.'¡'.$label;
                }
                $list_items = implode("\n", $list_pairs);
            } elseif (!empty($row->m_field_list_items)) {
                $list_items = $row->m_field_list_items;
            }
