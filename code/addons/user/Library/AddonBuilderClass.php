 ...
 * @version     2.0.1
 * @filesource  user/Library/AddonBuilderClass.php
 */

namespace EEHarbor\User\Library;

class AddonBuilderClass
{
    /**
     * AOB version
    ...
    public function __construct($init_type = '')
    {
        ...
        //This assumes we are in addon_name/Library/AddonBuilderClass.php
     ...
     * Model
     *
     * Legacy support for EE 2.x AddonBuilderClass model calling via
     * Codeigniter
     *
     * @deprecated
     * @access  public
