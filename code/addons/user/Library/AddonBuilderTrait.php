 ...
 * @version     2.0.1
 * @filesource  User/Library/AddonBuilderTrait.php
 */

namespace EEHarbor\User\Library;

trait AddonBuilderTrait
{
    /**
     * AOB version
    ...
    public function addonBuilderConstruct($init_type = '')
    {
        ...
        //This assumes we are in addon_name/Library/AddonBuilderTrait.php
        ...
        if (!empty($init_type) && is_callable(array($this, $possible_init))) {
            $this->$possible_init();
        }
    }
    // END __construct()
     ...
     * Model
     *
     * Legacy support for EE 2.x AddonBuilderTrait model calling via
     * Codeigniter
     *
     * @deprecated
     * @access  public
