...
use EEHarbor\User\FluxCapacitor\Base\Upd;
use EEHarbor\User\Library\AddonBuilderTrait;

class User_upd extends Upd
{
    use EEHarbor\User\Library\AddonBuilderTrait;
    ...
    public function uninstall()
    {
        ...
        // Disabled 2019-12-10 due to reports of corruption of all existing ee layouts.
    ...
    public function update($current = "")
    {
        ...
        if (version_compare($this->database_version(), '4.0.10', '<')) {
            ee()->db->insert(
                'exp_actions',
                array(
