...
$lang = array(
	...
	'cache_path_note' => 'Assumed to be absolute, but will also test as relative to the Base Path.<br />If left blank, will guess `assets`.',
	'cache_path_hint' => 'e.g. ' . rtrim(FCPATH, '/') . '/assets',

	'cache_url' => 'Cache URL',
	'cache_url_note' => 'Assumed to be a fully qualified URL, but will also test as relative to the Base URL.<br />If left blank, will guess `assets`.',
	'cache_url_hint' => 'e.g. ' . rtrim(get_instance()->config->item('base_url'), '/') . '/assets',
